...
import com.ecommerce.photomanager.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ecommerce.photomanager.domain.Folder}.
 */
@RestController
@RequestMapping("/api")
public class FolderResource {
    ...
    private static final String ENTITY_NAME = "photodbFolder";
    ...
    public ResponseEntity<FolderDTO> updateFolder(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, folderDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<FolderDTO> partialUpdateFolder(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, folderDTO.getId())
        );
    }
