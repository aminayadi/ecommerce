...
import com.ecommerce.client.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ecommerce.client.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    private static final String ENTITY_NAME = "clientdbClient";
