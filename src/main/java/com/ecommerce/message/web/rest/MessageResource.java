...
import com.ecommerce.message.service.MessageService;
import com.ecommerce.message.service.dto.MessageDTO;
import com.ecommerce.message.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ecommerce.message.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
    ...
    private static final String ENTITY_NAME = "messagedbMessage";
