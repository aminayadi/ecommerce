...
describe('Fields routing resolve service', () => {
  ...
  let routingResolveService: FieldsRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(FieldsRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return IFields returned by find', () => {
      ...
      expect(resultFields).toEqual({ id: 'ABC' });
    });
